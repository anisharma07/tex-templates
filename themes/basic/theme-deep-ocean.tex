...
% Theme 2: Deep Ocean (Navy & Gold)
\definecolor{oceanblue}{RGB}{0, 24, 51}
\definecolor{goldaccent}{RGB}{212, 175, 55}

\setbeamercolor{frametitle}{fg=goldaccent,bg=oceanblue}
\setbeamercolor{title}{fg=oceanblue}
\setbeamercolor{structure}{fg=oceanblue}
\setbeamercolor{normal text}{fg=black,bg=white}
\setbeamercolor{block title}{bg=oceanblue, fg=goldaccent}
\setbeamercolor{block body}{bg=oceanblue!10}
\setbeamercolor{alertblock title}{bg=goldaccent, fg=oceanblue}
\setbeamercolor{alertblock body}{bg=goldaccent!10}
