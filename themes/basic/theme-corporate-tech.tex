...
% Theme 9: Corporate Tech (Blue & Grey)
\definecolor{corpblue}{RGB}{0, 85, 150}
\definecolor{corpgrey}{RGB}{230, 230, 230}

\setbeamercolor{frametitle}{fg=white,bg=corpblue}
...
\setbeamercolor{block body}{bg=corpgrey}
