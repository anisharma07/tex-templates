...
% Theme 10: Burnt Orange (Warm)
\definecolor{burntorange}{RGB}{204, 85, 0}
\definecolor{warmgrey}{RGB}{60, 60, 60}
...
\setbeamercolor{normal text}{fg=warmgrey,bg=white}
\setbeamercolor{block title}{bg=burntorange, fg=white}
\setbeamercolor{block body}{bg=burntorange!10}
