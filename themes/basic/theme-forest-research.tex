...
\setbeamercolor{block body}{bg=forestgreen!10}
\setbeamercolor{alertblock title}{bg=earthbrown, fg=white}
\setbeamercolor{alertblock body}{bg=earthbrown!10}
