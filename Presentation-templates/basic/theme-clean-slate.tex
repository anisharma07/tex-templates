...
\usefonttheme{professionalfonts} % Sans serif for modern look
...
% Theme 3: Clean Slate (Grey & Blue)
\definecolor{slategrey}{RGB}{47, 79, 79}
\definecolor{softblue}{RGB}{70, 130, 180}

\setbeamercolor{frametitle}{fg=white,bg=slategrey}
\setbeamercolor{title}{fg=slategrey}
\setbeamercolor{structure}{fg=softblue}
\setbeamercolor{normal text}{fg=black,bg=white}
\setbeamercolor{block title}{bg=softblue, fg=white}
\setbeamercolor{block body}{bg=softblue!10}
