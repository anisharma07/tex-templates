...
\titleformat{\section}
{\normalfont}{}{0em}
{\begin{tcolorbox}[colback=black!70,colframe=black!70,coltext=white,boxrule=0pt,arc=3pt,left=2pt,right=2pt,top=1pt,bottom=1pt,fontupper=\bfseries\small\MakeUppercase]##1\end{tcolorbox}}
...
\begin{center}
    {\LARGE \textbf{COMPLEXITY CHEAT SHEET (BOXED)}}
\end{center}
