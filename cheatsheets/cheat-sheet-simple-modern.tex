...
% Modern Header
\titleformat{\section}
{\color{themeblue}\large\bfseries\scshape}{}{0em}
{\colorbox{headerbg}{\parbox{\dimexpr\linewidth-2\fboxsep\relax}{\centering ##1}}}
...
\begin{center}
    {\LARGE \textbf{\color{themeblue} COMPLEXITY CHEAT SHEET (MODERN)}}
\end{center}
